...
# Wire contract identifiers. These intentionally preserve the server ingress
# queue contract so the thin client can enqueue compatible
# ``rag_ingress_enqueue.v1`` payloads without importing server code.
