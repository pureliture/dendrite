...
def build_parser() -> ArgumentParser:
    ...
    hook_plan.add_argument("--provider", required=True, choices=["claude", "gemini", "codex", "antigravity", "hermes"])
    ...
    capture.add_argument("--provider", required=True, choices=["claude", "gemini", "codex", "antigravity", "hermes"])
